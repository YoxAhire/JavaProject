...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
                ...
                String month[] = {"January","February","March","April","May","June","July","Augast","September","October","November","December"};
                ...
                System.out.println("Outside Signup()");
           }   
                    ...
                    String j = t7.getText();
                        ...
                        try{
                                ...
                                if(t6.getText().equals("")){
                                  ...
                                  //JOptionPane.showMessageDialog("Please filled all required details");
                                  ...
                                  //String q1 = "insert into  signup values ('"+1+"','"+a+"','"+b+"','"+ac+"','"+bc+"','"+cc+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"' )";
                                  ...
                                  //int records = c1.s.executeUpdate();
