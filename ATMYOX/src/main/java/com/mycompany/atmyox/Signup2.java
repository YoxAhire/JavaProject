...
public class Signup2  extends JFrame implements ActionListener{
   ...
   Signup2(){
            ...
            String income[] = {"null","<1,50,000","<2,50,000","<5,00,000","Up to 10,00,000"};
            ...
            String occupation[] = {"polititian","Teacher","singer","dancer","Other"};
            ...
            c4.setBounds(350,270,150,30);
            add(c4);

            c5.setBounds(350,330,150,30);
            add(c5);
            ...
            t1.setBounds(350,390,150,30);
            add(t1);

            l8.setBounds(100,440,180,30);
            add(l8);

            t2.setBounds(350,440,180,30);
            add(t2);
